/**
 * puestosConstants.ts — MEJ-21
 *
 * Fuente canónica de PUESTOS_DEFAULT para toda la aplicación.
 */
import type { Distancia, TipoPuesto } from '@/constants/voluntariosConstants';

export interface PuestoDefault {
  id: number;
  nombre: string;
  tipo: TipoPuesto | string;
  distancias: (Distancia | string)[];
  horaInicio: string;
  horaFin: string;
  necesarios: number;
...
export const PUESTOS_DEFAULT: PuestoDefault[] = [
  ...
  { id:6,  nombre:'Punto Control KM 13',      tipo:'Control',          distancias:['TG25'],             horaInicio:'09:00', horaFin:'15:00', necesarios:2,  responsableId:null, localizacionId:6,  tiempoLimite:'14:00', notas:'Registro de dorsales, corte de tiempos. Corredores que lleguen después del tiempo límite deben ser retirados.' },
