...
export const TIPOS_DOC = ["Contrato","Presupuesto","Factura","Justificante de pago","Póliza de seguro","Cobertura seguro","Acuerdo patrocinio","Otro"];

export const SECTORES = ["Deportes / Outdoor", "Alimentación / Nutrición", "Salud / Fisioterapia", "Hostelería / Turismo", "Comercio local", "Administración pública", "Transporte / Automoción", "Tecnología", "Medios / Comunicación", "Otro"];
